...
const CLIENT_NOTES_BY_TYPE = {
    "Телефон": [
        ...
        "Телефон стал дымить после игры в AR 🕹️",
        "Попытался подзарядить через пауэрбанк для ноутбука 🔌"
    ],
    "Ноутбук": [
        ...
        "Ноутбук стал горячим после марафона Netflix 🍿"
    ],
    "ПК": [
        ...
        "PC случайно отправился в космос с дроном 🚀"
    ],
    "Сервер": [
        ...
        "Сервер внезапно превратился в мини-планетарий 🌌"
    ],
    "Суперкомпьютер": [
        ...
        "Суперкомпьютер случайно решил стать искусственным интеллектом 🤖"
    ],
    "Планшет": [
        ...
        "Планшет решил обновиться самопроизвольно и завис 🔄"
    ],
    "Игровая консоль": [
        ...
        "Консоль случайно подключилась к микроволновке и сгорела 🍲"
    ],
    "Холодильник с Wi-Fi": [
        ...
        "Холодильник решил сам приготовить смузи 🥤"
    ],
    "3D-принтер": [
        "Напечатал себе кружку, теперь она с дырками 🏺",
        "Принтер напечатал кота вместо деталей 🐱",
        "Пытался распечатать ключ, получилось что-то странное 🗝️"
    ],
    "Робот-пылесос": [
        "Пылесос затерялся в шкафу и отправился в кругосветку 🧹",
        "Собрал все носки в одну кучу 🧦",
        "Робот устроил вечеринку с игрушками 🤖"
    ],
    "Смарт-часы": [
        "Считали шаги даже во сне 🛌",
        "Попытался измерить давление у кота 🐈",
        "Часы начали уведомлять о встречах соседей 📅"
    ]
};

// Расширенные шаблоны заказов
const ORDER_TEMPLATES = [
    ...
    { type: '3D-принтер', minCompleted: 25, baseParts: { cpu:1, ram:3, motherboard:1, case:3 }, baseTime: 420, baseReward: 900, rare: true  },
    { type: 'Робот-пылесос', minCompleted: 35, baseParts: { battery:2, cpu:1, ram:1 }, baseTime: 250, baseReward: 120 },
    { type: 'Смарт-часы', minCompleted: 15, baseParts: { battery:1, cpu:1 }, baseTime: 130, baseReward: 60 }
];
